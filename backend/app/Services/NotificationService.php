...
class NotificationService
{
    ...
    public static function defaultTemplates(): array
    {
        return [
            ...
            ['type' => 'order_placed', 'channel' => 'sms', 'subject' => null, 'body_template' => 'DK MEUBLE : commande {{order_number}} reçue. Total {{order_total}} FCFA.'],
            ['type' => 'order_placed', 'channel' => 'whatsapp', 'subject' => null, 'body_template' => 'DK MEUBLE : commande {{order_number}} reçue. Total {{order_total}} FCFA. Merci !'],
            ...
            ['type' => 'order_status', 'channel' => 'whatsapp', 'subject' => null, 'body_template' => 'DK MEUBLE : commande {{order_number}} → {{order_status}}'],
            ...
            ['type' => 'newsletter', 'channel' => 'email', 'subject' => 'Meilleures offres DK MEUBLE', 'body_template' => "Découvrez nos meilleures offres de la semaine.\n{{link}}"],
